...
df1 = onehotencoder.fit_transform(df1).toarray()
df1 = df1[:, 1:]
onehotencoder = OneHotEncoder(categorical_features = [101])
df1 = onehotencoder.fit_transform(df1).toarray()
df1 = df1[:, 1:]
onehotencoder = OneHotEncoder(categorical_features = [124])
df1 = onehotencoder.fit_transform(df1).toarray()
df1 = df1[:, 1:]
...
df1 = onehotencoder.fit_transform(df1).toarray()
df1 = df1[:, 1:]
onehotencoder = OneHotEncoder(categorical_features = [196])
df1 = onehotencoder.fit_transform(df1).toarray()
df1 = df1[:, 1:]
onehotencoder = OneHotEncoder(categorical_features = [213])
df1 = onehotencoder.fit_transform(df1).toarray()
df1 = df1[:, 1:]
...
classifier.add(Dense(output_dim = 6, init = 'uniform', activation = 'relu', input_dim = 229))
